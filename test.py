...
def o():
    ...
    if Radif == '3':
        os.system('xdg-open https://www.github.com/ARIYAN-404-CYBAR')
    if Radif == '4':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100079143742521')
    if Radif == '0':
        os.system('exit')
...
\033[1;96m[\033[1;91m[+]\033[1;92m]\033[1;95m VERSION \033[1;94m : \033[1;92m0.7
\033[1;97m====================ARIYAN==============================\n""")
